...
class PdfEvaluacion extends \TCPDF {
   ...
   public function Header() {
        ...
        $this->Cell(0,5,'Evaluacion de Desempeño por Competencia',0,1,'C');

        // Logo
        $image_file ='img/dnm.png';
        $this->Image($image_file, 178, 10, 20, '', 'PNG', '', 'T', false, 300, '', false, false, 0, false, false, false);

        $image_file2 = 'img/escudo.png';
        $this->Image($image_file2, 15, 10, 20, '', 'PNG', '', 'T', false, 300, '', false, false, 0, false, false, false);
