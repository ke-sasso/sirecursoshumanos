...
<div class="panel panel-success">
    <div class="panel-heading" >
        <h3 class="panel-title">
            ...
            B&uacute;squeda Avanzada de Productos
...
$(document).ready(function() {
  ...
  var table = $('#dt-capacitaciones-items').DataTable({
    ...
    columns: [
        ...
        {data: 'idProducto', name: 'idProducto'},//9
        {data: 'nombreProducto', name: 'nombreProducto'},//10
          ...
          action: function (e,dt,node,config) {
            ...
            if(table.data().any()){
              $.ajax({
                  cache: false,
                  data:   params,
                  url:   "{{ route('rh.capacitaciones.productos.expExcel') }}",
                  type:  'get',
                  beforeSend: function() {
