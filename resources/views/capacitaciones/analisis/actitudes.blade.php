...
<div class="panel panel-success">
    <div class="panel-heading" >
        <h3 class="panel-title">
            ...
            B&uacute;squeda Avanzada de Actitudes
    ...
    <table class="table table-striped table-hover" id="dt-capacitaciones-items" style="font-size:13px;" width="100%">
        <thead class="the-box dark full">
            <tr>
                ...
                <th>Id Tipo Actitud</th>
                <th width="50%">Actitud</th>
                <th>Evaluación</th>
...
$(document).ready(function() {
  ...
  var table = $('#dt-capacitaciones-items').DataTable({
      ...
      searching: false,
      ajax: {
        url: "{{ route('dt.row.data.rh.capacitaciones.actitudes') }}",
        data: function(d){
      ...
      columns: [
          ...
          {data: 'idTipoActitud', name: 'idTipoActitud'},//7
          {data: 'nombreTipoActitud', name: 'nombreTipoActitud'},//8
          ...
          action: function (e,dt,node,config) {
            ...
            if(table.data().any()){
              $.ajax({
                  cache: false,
                  data:   params,
                  url:   "{{ route('rh.capacitaciones.actitudes.expExcel') }}",
                  type:  'get',
                  beforeSend: function() {
