...
<form role="form" method="post" action="{{route('guardar.estadoLaboral')}}" autocomplete="off" id="formEstadoLaboral">
   ...
   <div class="row">
    <div class="col-sm-12 col-md-12">
     <div class="input-group ">
      ...
      <input type="text" class="form-control" id="nombre" name="descripcionLaboral" autocomplete="off" >
    </div>
  </div>
</div>
</div>
...
<div class="from-group" align="center">
 ...
 <a href="{{route('estadoLaboral.listar')}}" style="" type="button" id="cancelar" class="btn btn-warning btn-perspective">Regresar<i class="fa fa-reply" aria-hidden="true"></i></a>
</div>
...
$('#formEstadoLaboral').submit(function(e){
  var formObj = $(this);
