...
@endif
        ...
        <form role="form" method="post" action="{{route('guardar.tipoActitud')}}" autocomplete="off" id="formTipoActitud">
                ...
                <div class="form-group">
                     <div class="row">
                      ...
                      <div class="from-group" align="center">
                       ...
                       <a href="{{route('tipoActitud.listar')}}" style="" type="button" id="cancelar" class="btn btn-warning btn-perspective">Regresar<i class="fa fa-reply" aria-hidden="true"></i></a>
                      </div>
...
//inicio almacenar el nuevo principio activo
  $.ajaxSetup({
    ...
    $('#formTipoActitud').submit(function(e){
        var formObj = $(this);
      ...
      success:  function (response){
            ...
            if(isJson(response)){
              alertify.alert("Mensaje de Sistema","<strong><p class='text-justify'>¡Informaci&oacute;n registrada de forma exitosa!</p></strong>",function(){
                ...
                window.location.href = "{{route('insertar.tipoActitud')}}";
              });
