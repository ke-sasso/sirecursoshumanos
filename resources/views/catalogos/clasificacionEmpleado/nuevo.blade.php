...
<form role="form" method="post" action="{{route('guardar.clasificacionEmpleado')}}" autocomplete="off" id="formClasificacionEmpleado">
 
 <div class="form-group">
   <div class="row">
    <div class="col-sm-12 col-md-12">
     <div class="input-group ">
      <div class="input-group-addon"><b>Nombre de la clasificacion</b></div>
...
<div class="from-group" align="center">
 ...
 <a href="{{route('clasificacionEmpleado.listar')}}" style="" type="button" id="cancelar" class="btn btn-warning btn-perspective">Regresar<i class="fa fa-reply" aria-hidden="true"></i></a>
</div>
...
$('#formClasificacionEmpleado').submit(function(e){
  var formObj = $(this);
    ...
    success:  function (response){
      ...
      if(isJson(response)){
        alertify.alert("Mensaje de Sistema","<strong><p class='text-justify'>¡Informaci&oacute;n registrada de forma exitosa!</p></strong>",function(){
          ...
          window.location.href = "{{route('insertar.clasificacionEmpleado')}}";
        });
