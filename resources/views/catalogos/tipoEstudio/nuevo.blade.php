...
@endif
              ...
              <form role="form" method="post" action="{{route('guardar.tipoEst')}}" autocomplete="off" id="formTipoEst">
                    ...
                    <div class="col-sm-12 col-md-12">
                     <div class="input-group ">
                      ...
                      <div class="from-group" align="center">
                       ...
                       <a href="{{route('tipoEst.listar')}}" style="" type="button" id="cancelar" class="btn btn-warning btn-perspective">Regresar<i class="fa fa-reply" aria-hidden="true"></i></a>
                      </div>
      ...
      success:  function (response){
            ...
            if(isJson(response)){
              alertify.alert("Mensaje de Sistema","<strong><p class='text-justify'>¡Informaci&oacute;n registrada de forma exitosa!</p></strong>",function(){
                ...
                window.location.href = "{{route('insertar.tipoEst')}}";
              });
