...
@endif
              ...
              <form role="form" method="post" action="{{route('guardar.institucion')}}" autocomplete="off" id="formInstitucion">
                    ...
                    <div class="col-sm-12 col-md-6">
                     <div class="input-group ">
                      <div class="input-group-addon"><b>Pa&iacute;s</b></div>
                        <select name="idPais" id="idPais" class="form-control select_plaza js-states" 
                             style="width: 100%;" >
                              <option></option>
                        </select>
                     ...
                     <div class="input-group ">
                      ...
                      <div class="from-group" align="center">
                       ...
                       <a href="{{route('institucion.listar')}}" style="" type="button" id="cancelar" class="btn btn-warning btn-perspective">Regresar<i class="fa fa-reply" aria-hidden="true"></i></a>
                      </div>
...
//inicio almacenar el nuevo principio activo
  $.ajaxSetup({
    ...
    $('#formInstitucion').submit(function(e){
        var formObj = $(this);
      ...
      success:  function (response){
            ...
            if(isJson(response)){
              alertify.alert("Mensaje de Sistema","<strong><p class='text-justify'>¡Informaci&oacute;n registrada de forma exitosa!</p></strong>",function(){
                ...
                window.location.href = "{{route('insertar.institucion')}}";
              });
      ...
      return true;
        ...
        var $states = $(".js-source-states");
                    ...
                    $(".select_plaza").select2({
                        placeholder: "Seleccione el país de la institución...",
                        allowClear: true
                    });
