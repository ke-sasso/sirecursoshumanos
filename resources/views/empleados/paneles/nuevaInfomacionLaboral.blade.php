<div class="modal fade modal-center" id="nuevaInfoLaboral"  style='display:none;' tabindex="-1" role="dialog" >
    <div class="modal-dialog modal-lg" >
        <div class="modal-content">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <h4 class="modal-title" id="frmModalLabel">
                   NUEVA INFORMACI&Oacute;N LABORAL
                </h4>
            </div>
      ...
      <div class="modal-body">
        ...
        <form role="form" method="post" action="{{route('post.nueva.infolaboral')}}"   autocomplete="off" id="formNuevaInfoLaboral">
                    ...
                    <div class="col-sm-12 col-md-12">
                     <div class="input-group ">
                      <div class="input-group-addon"><b>Plaza funcional</b></div>
                          <select name="idPadre" id="idPadre" style="width:600px; z-index: 110;" class="form-control chosen" >
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-6 col-md-6">
                     <div class="input-group ">
                      ...
                      <input type="date" class="form-control" id="fechaInicio" name="fechaInicio" data-date-format="yyyy-mm-dd">
                    </div>
                    </div>
                     <div class="col-sm-6 col-md-6">
                     <div class="input-group ">
                      <div class="input-group-addon"><b>Fecha fin</b></div>
                      <input type="date" class="form-control" id="fechaFin" name="fechaFin" data-date-format="yyyy-mm-dd">
                    </div>
                    </div>
                    </div>
                </div>
