...
<div class="the-box">
	...
	<h4 class="small-title">Solicitud de Licencia: </h4>
		...
		<form id="formLicencia" method="post" action="{{ route('autorizar.superior') }}" autocomplete="off">
						...
						<label>EN EL PERIODO COMPRENDIDO:</label>
							<div class="row">
								<div class="col-sm-6 col-md-3 col-lg-3">
									...
									{!! Form::text('fechaInicio',date_format(date_create($solicitud->fechaInicio),'d-m-Y'),['id'=>'fechaInicio','class' => 'form-control datepicker','data-date-format'=>'yyyy-mm-dd','placeholder'=>'yyyy-mm-dd', 'disabled'])!!}
									</div><!-- /.form-group -->
								</div><!-- /.col-sm-6 -->
								<div class="col-sm-6 col-md-3 col-lg-3">
									<div class="form-group">
									<label>Fecha Fin</label>
									{!! Form::text('fechaFin',date_format(date_create($solicitud->fechaFin),'d-m-Y'),['id'=>'fechaFin','class' => 'form-control datepicker','data-date-format'=>'yyyy-mm-dd','placeholder'=>'dd-mm-yyyy', 'disabled'])!!}
									</div><!-- /.form-group -->
								</div><!-- /.col-sm-6 -->
